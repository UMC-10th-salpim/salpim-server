...
public class FacilityController {
    ...
    @Operation(
        summary = "시설 상세 정보 조회",
        description = "시설 이름과 유저의 관할동을 비교하여 정보를 반환하며, 혜택 리스트는 커서 기반 페이징으로 응답합니다.",
    ...
    public ApiResponse<MapResponseDTO.FacilityInfoResponseDto> getFacilityDetails(
        ...
        MapResponseDTO.FacilityInfoResponseDto result = facilityService.getFacilityInfo(effectiveMemberId, request, effectiveCursor, effectiveSize);
